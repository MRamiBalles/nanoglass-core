...
\textbf{Experimental Note:} All results presented in this work were obtained using a \textbf{Synthetic Toy Hamiltonian} based on the Gibbs Free Energy equations. These synthetic reasoning chains serve as a proof-of-concept for the *Thermo-Causal* scaling hypothesis on resource-constrained hardware (CPU). Future work will involve ingestion of empirical thermochemical datasets (e.g., NIST-JANAF \cite{JANAF}).
